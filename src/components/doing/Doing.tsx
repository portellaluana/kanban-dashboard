...
//     localStorage.setItem("tarefas-fazendo", JSON.stringify([...tasks, newItem]));
//   }
...
//       localStorage.setItem("tarefas-fazendo", JSON.stringify(updatedSourceTasks));
//       localStorage.setItem("tarefas-concluidas", JSON.stringify(updatedDestinationTasks));
//     } else {
//       const updatedTasks = reoder([...tasks], sourceIndex, destinationIndex);
//       setTasks(updatedTasks);

//       localStorage.setItem("tarefas-fazendo", JSON.stringify(updatedTasks));
//     }
//   }
...
//             <Droppable droppableId="tasks-doing" type="list" direction="vertical">
//               {(provided) => (
